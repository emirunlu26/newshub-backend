...
urlpatterns = [
    ...
    path("posts/<int:post_id>/react/", views.create_view_update_delete_reaction_to_post
         , name="create-view-update-delete-reaction-to-post"),
    path("comments/<int:comment_id>/react", views.create_view_update_delete_reaction_to_comment
         , name="create-view-update-delete-reaction-to-comment"),
